...
function Alternative() {
    ...
    React.useEffect(() => {
        async function fetchData() {
            try {
                const response = await fetch(`https://discoveryprovider.audius.co/v1/tracks/trending?genre=${"alternative"}&time=${'allTime'}`, {
                    method: 'GET',
                });
    ...
    const handleClick = async (e:any) => {
        ...
        try {
            const response = await fetch(`https://discoveryprovider.audius.co/v1/tracks/trending?genre=${"alternative"}&time=${time}`, {
                method: 'GET',
            });
